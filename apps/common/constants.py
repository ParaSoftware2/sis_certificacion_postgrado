...
TIPO_FIRMA_RECTOR = 'rector'
TIPO_FIRMA_DIRECTOR = 'director'
TIPO_FIRMA_JEFE_OGCU = 'jefe_ogcu'
TIPO_FIRMA_DIRECCION_GESTION_CALIDAD = 'director_direccion_gestion_calidad'
TIPO_FIRMA_DIRECCION_AUTOEVALUACION = 'director_direccion_autoevaluacion'
TIPO_FIRMA_DIRECCION_LICENCIAMIENTO = 'director_direccion_licenciamiento'
TIPO_FIRMA_PRESIDENTE_CCEAD = 'presidente_ccead'
TIPO_FIRMA_VICERRECTOR_ACADEMICO = 'vicerrector_academico'
TIPO_FIRMA_VICERRECTOR_INVESTIGACION = 'vicerrector_investigacion'
...
TIPO_FIRMA_CHOICES = (
    (TIPO_FIRMA_RECTOR, 'RECTOR'),
    (TIPO_FIRMA_DIRECTOR, 'DIRECTOR'),
    (TIPO_FIRMA_JEFE_OGCU, 'JEFE OGCU'),
    (TIPO_FIRMA_DIRECCION_GESTION_CALIDAD, 'DIRECTOR DIRECCIÓN GESTIÓN DE CALIDAD'),
    (TIPO_FIRMA_DIRECCION_AUTOEVALUACION, 'DIRECTOR DIRECCIÓN DE AUTOEVALUACIÓN Y ASEGURAMIENTO DE LA CALIDAD'),
    (TIPO_FIRMA_DIRECCION_LICENCIAMIENTO, 'DIRECTOR DIRECCIÓN DE LICENCIAMIENTO'),
    (TIPO_FIRMA_VICERRECTOR_ACADEMICO, 'VICERRECTOR ACADÉMICO'),
    (TIPO_FIRMA_VICERRECTOR_INVESTIGACION, 'VICERRECTOR DE INVESTIGACIÓN'),
